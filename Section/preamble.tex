...
\hypersetup{
    ...
    pdfsubject = {The AWK Programming Language},
    pdfkeywords = {awk, pattern scanning, text processing}
}

% from package fontspec and xeCJK
\setCJKmainfont{Inziu-Iosevka-SC-Regular}
\setCJKsansfont{Inziu-Iosevka-SC-Regular}
\setCJKmonofont[Scale=0.9]{SourceCodePro-ExtraLight}
\setmainfont{Inziu-Iosevka-SC-Regular}
\setsansfont{Inziu-Iosevka-SC-Regular}
% "Mapping={}" make quote symbol straight
\setmonofont[Mapping={}]{SourceCodePro-ExtraLight}
